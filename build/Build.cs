...
class Build : NukeBuild
{
    ...
    Target Clean => _ => _
        .Executes(() =>
        {
            ...
            binFolder.GlobDirectories(pattern).SelectMany(x => x.GlobDirectories(pattern)).ForEach(FileSystemTasks.DeleteDirectory);
            
            DotNetTasks.DotNetRestore(_ => DotNetRestoreSettingsExtensions.SetProjectFile<DotNetRestoreSettings>(_, msBuildProject.FullPath)
            );
        });
    ...
    Target RawBuild => _ => _
        ...
        .Executes(() =>
        {
            ...
            DotNetTasks.DotNetBuild(_ => DotNetBuildSettingsExtensions.SetProjectFile<DotNetBuildSettings>(_, msBuildProject.FullPath)
    ...
    Target BuildModFile => _ => _
        ...
        .Executes(() =>
        {
            ...
            CompressionTasks.CompressZip(tempPath, modFile, compressionLevel: CompressionLevel.Optimal, fileMode: FileMode.Create);
        });
