...
public class GraphicPipelines
{
    ...
    internal static unsafe GraphicsPipelineDescription ColorDescription(IVulkanEngine vulkanEngine)
    {
        Rect2D scissor = new()
        {
    ...
    internal static unsafe GraphicsPipelineDescription TextureDescription(IVulkanEngine vulkanEngine)
    {
        ...
        GraphicsPipelineDescription pipelineDescription = new()
        {
            ...
            Viewports = new[] {viewport},
            DescriptorSets = new[]
                {DescriptorSetIDs.CameraBuffer, MintyCore.Identifications.DescriptorSetIDs.SampledTexture},
            Flags = 0,
            Topology = PrimitiveTopology.TriangleList,
            DynamicStates = dynamicStates,
            RenderPass = default,
    ...
    internal static unsafe GraphicsPipelineDescription UiOverlayDescription(IVulkanEngine vulkanEngine)
    {
        Rect2D scissor = new()
        {
            Extent = vulkanEngine.SwapchainExtent,
